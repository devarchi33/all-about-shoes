...
import (
	...
	"github.com/devarchi33/all-about-shoes-api/config"
	"github.com/devarchi33/all-about-shoes-api/controllers"
...
func initEchoApp(xormEngine *xorm.Engine) *echo.Echo {
	...
	r := echoswagger.New(e, "doc", &echoswagger.Info{
		Title:       "All About Shoes API",
		Description: "This is docs for all-about-shoes-api",
		Version:     "1.0.0",
	})
	InitControllers(e)
	...
	controllers.ShoesController{}.Init(r.Group("Shoes", "/v1/shoes"))
	return e
}
